...
def get_dashboard_status_for_netid(netid: str) -> DashboardRequestStatus:
    ...
    with DbSession() as session:
        ...
        if not active_request:
            return DashboardRequestStatus.NOT_REQUESTED

        return active_request.request_status
...
def register_user_dashboard_request(netid: str, dashboard_request: DashboardRequestInfo):
    with DbSession() as session:
        ...
        request = UserDashboardRequestsModel(
            ...
            job_size_input_gb = dashboard_request.job_input_size,
            job_size_output_gb = dashboard_request.job_output_size,
